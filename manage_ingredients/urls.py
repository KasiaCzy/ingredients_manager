...
urlpatterns = [
    ...
    path('edit_owned_ingredient/<int:owned_ingredient_id>/', views.edit_owned_ingredient,
    ...
    path('delete_owned_ingredient/<int:owned_ingredient_id>/', views.delete_owned_ingredient,
    ...
    path('use_up_today/edit_owned_ingredient/<int:owned_ingredient_id>/', views.edit_owned_ingredient,
    ...
    path('use_up_today/delete_owned_ingredient/<int:owned_ingredient_id>/', views.delete_owned_ingredient,
